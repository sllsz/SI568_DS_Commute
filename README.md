This is the repo for SI568's Project 3. The initial data exploration focuses on the CITI Bike Data from 202102 to 202602. The current dataset is not pushed due to the size of it. So please download the data on your own machine locally.
